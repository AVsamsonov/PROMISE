...
// Derives a fixture FooTest from NodeTest.
class FooTest : public NodeTest {
 protected:
  void SetUp() override {
    NodeTest::SetUp();  // Sets up the base fixture first.
    ... additional set-up work ...
  }

  void TearDown() override {
    ... clean-up work for FooTest ...
    NodeTest::TearDown();  // Remember to tear down the base fixture
...
... additional fixtures derived from NodeTest ...
```
...
```c++
typedef NodeTest FooTest;

TEST_F(FooTest, Abc) { ... }
TEST_F(FooTest, Def) { ... }

typedef NodeTest BarTest;
